...
import { getMenuBarShortcutsApplescript, getMenuBarShortcutsCache, getTotalMenuBarItemsApplescript } from "../utils";
...
export function useMenuItemsLoader() {
  ...
  }), [loading, app?.name, data, totalMenuItems, loadingMessage, loadingState, loaded]);
}
